// Pure-data list of demo-preset keys for the /new-features/multiplayer-editing
// page. Mirrors exactly the keys (and order) of MULTIPLAYER_EDITING_DEMOS in
// ./multiplayer-editing.tsx. No React/JSX, no imports, so the Sanity Studio
// bundle can import it without pulling in component code.

export const MULTIPLAYER_EDITING_DEMO_KEYS: string[] = [
  // hero tabs
