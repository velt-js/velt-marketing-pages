// Pure-data list of demo-preset keys for the /new-features/review-agents page.
// No imports: mirrors the keys of REVIEW_AGENTS_DEMOS (same keys, same order)
// so the Sanity schema and seed can reference them without pulling React code.

export const REVIEW_AGENTS_DEMO_KEYS: string[] = [
  // Hero tabs
