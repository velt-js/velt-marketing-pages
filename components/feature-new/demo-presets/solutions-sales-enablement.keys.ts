// Pure-data demo-preset keys for the /solutions/sales-enablement page. Mirrors
// the keys defined in ./solutions-sales-enablement.tsx. Imported by the keys
// aggregator (../demo-keys.ts) so the Sanity Studio dropdown lists them without
// pulling React into the Studio bundle.

export const SOLUTIONS_SALES_ENABLEMENT_DEMO_KEYS: string[] = [
