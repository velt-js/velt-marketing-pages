// Pure-data list of demo-preset keys for the /new-features/approval-flows page.
// No imports: mirrors the keys in ./approval-flows.tsx (same keys, same order)
// so the Sanity seed and schema can reference them without pulling React code.

export const APPROVAL_FLOWS_DEMO_KEYS: string[] = [
  // Hero tabs
