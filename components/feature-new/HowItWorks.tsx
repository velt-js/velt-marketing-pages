...
const ICON_BY_LABEL: Record<string, string> = {
  ...
  // Editors and surfaces
  "tiptap": `${ICON_BASE}/tiptap.svg`,
  "lexical": `${ICON_BASE}/lexical.svg`,
  "quill": `${ICON_BASE}/quill.svg`,
  "codemirror": `${ICON_BASE}/codemirror.svg`,
  "blocknote": `${ICON_BASE}/blocknote.svg`,
  "slate": `${ICON_BASE}/slatejs.png`,
  "prosemirror": `${ICON_BASE}/prosemirror.svg`,
  "monaco": `${ICON_BASE}/monaco.svg`,
  "ckeditor": `${ICON_BASE}/ckeditor.svg`,
  "draft.js": `${ICON_BASE}/draftjs.svg`,
  "ace": `${ICON_BASE}/ace.png`,
  "chart.js": `${ICON_BASE}/chartjs.svg`,
  "highcharts": `${ICON_BASE}/highcharts.svg`,
  "nivo": `${ICON_BASE}/nivocharts.svg`,
  "react flow": `${ICON_BASE}/reactflow.svg`,
