  ...
  return (
      <section id="verticals" className="vert-section">
        ...
        <div className="vert-grid">
          <a href="/solutions/sales-enablement" className="vert-card hcard">
          ...
          <a href="/solutions/fintech" className="vert-card hcard">
          ...
          <a href="/solutions/operations" className="vert-card hcard">
          ...
          <a href="/solutions/ai-native-saas" className="vert-card hcard">
