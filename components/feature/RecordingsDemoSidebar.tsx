...
const RECORDER_GITHUB =
  "https://github.com/velt-js/recorder-landing-page-demo";
...
const TABS: DemoTab[] = [
  {
    ...
    iframe:
      "https://recorder-landing-page-demo.vercel.app/?type=audio&backgroundColor=1A2A7C",
    github: RECORDER_GITHUB,
  },
  {
    label: "Video",
