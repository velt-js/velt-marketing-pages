...
// /:https://framerusercontent.com/modules/d2aTgp8BCfENcg4lzz2o/c64hMitkQwF2GpBgdCpt/codemirror_legacy_modes_mode_ruby.js
...
var ruby = { name: "ruby", startState: function(indentUnit) {
  return { tokenize: [tokenBase], indented: 0, context: { type: "top", indented: -indentUnit }, continuedLine: false, lastTok: null, varList: false };
...
}, languageData: { indentOnInput: /^\s*(?:end|rescue|elsif|else|\})$/, commentTokens: { line: "#" }, autocomplete: keywordList } };
var __FramerMetadata__ = { "exports": { "ruby": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "__FramerMetadata__": { "type": "variable" } } };
export {
  __FramerMetadata__,
  ruby
};
