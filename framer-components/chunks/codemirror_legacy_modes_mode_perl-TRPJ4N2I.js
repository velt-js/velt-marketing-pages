...
// /:https://framerusercontent.com/modules/l6yIFqJiKpzgjIjYLDe8/T0tpViTGwTexhSsVLm5n/codemirror_legacy_modes_mode_perl.js
...
var perl = { name: "perl", startState: function() {
  return { tokenize: tokenPerl, chain: null, style: null, tail: null };
}, token: function(stream, state) {
  return (state.tokenize || tokenPerl)(stream, state);
}, languageData: { commentTokens: { line: "#" }, wordChars: "$" } };
var __FramerMetadata__ = { "exports": { "perl": { "type": "variable", "annotations": { "framerContractVersion": "1" } }, "__FramerMetadata__": { "type": "variable" } } };
export {
  __FramerMetadata__,
  perl
};
