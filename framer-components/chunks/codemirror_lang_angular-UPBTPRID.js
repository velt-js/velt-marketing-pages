...
// /:https://framerusercontent.com/modules/EjHwngjQOz6g9296RZMV/OmqzdbFAa9BePMogE7r5/codemirror_lang_angular.js
var Text = 1;
...
function angular(config = {}) {
  ...
  return new LanguageSupport(base.language == baseHTML.language ? angularLanguage : mkAngular(base.language), [base.support, base.language.data.of({ closeBrackets: { brackets: ["[", "{", '"'] }, indentOnInput: /^\s*[\}\]]$/ })]);
}
