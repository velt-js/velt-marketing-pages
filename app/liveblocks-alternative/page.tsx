...
const LIVEBLOCKS_ALT_DESCRIPTION =
  "Velt is the #1 Liveblocks alternative: a production-grade collaboration SDK trusted by leading SaaS products. Compare pricing, scalability, security, and support.";
