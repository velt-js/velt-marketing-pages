...
const INTEGRATIONS_WEBPAGE = buildWebPageSchema({
  ...
  url: `${SITE_URL}/integrations-old`,
  breadcrumb: INTEGRATIONS_BREADCRUMB,
});

const INTEGRATIONS_FAQ_SCHEMA = buildFaqPageSchemaFromEntries(sharedFAQ);

// Old detail pages moved to /integrations-old; remap the shared card hrefs so
// this legacy grid links within the moved namespace.
const OLD_INTEGRATION_CARDS = allIntegrationCards.map((card) => ({
  ...card,
