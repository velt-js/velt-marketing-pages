...
const doc = {
  ...
  enterprise: {
    badges: [...DEPLOYMENT_BADGES, "EU data residency", "Permission-scoped"],
    line: `Notification content can live on your infrastructure via the self-host data provider, with only minimal identifiers on Velt. Notifications generate only for documents a user can access, so internal deliberation never reaches the wrong inbox. ${CLOUD_STATUS_LINE}`,
