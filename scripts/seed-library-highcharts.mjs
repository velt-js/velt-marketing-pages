...
async function main() {
  ...
  const previewImage = await uploadImage(
    "public/images/home/libraries/demos/highcharts.png",
  );
  ...
  const doc = {
    ...
    hero: {
      ...
      secondaryCta: {
        _type: "ctaLink",
        label: "View Docs",
        href: "https://velt.dev/docs/async-collaboration/comments/setup/chart-comments-setup/highcharts",
        newTab: true,
      },
    },
    demoStage: {
    ...
    getStartedCallout: {
      ...
      viewDocsHref:
        "https://velt.dev/docs/async-collaboration/comments/setup/chart-comments-setup/highcharts",
