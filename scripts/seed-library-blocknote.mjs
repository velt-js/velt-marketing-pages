...
async function main() {
  ...
  const previewImage = await uploadImage(
    "public/images/home/libraries/demos/blocknote.png",
  );
  ...
  const doc = {
    ...
    bento: {
      ...
      viewDocsCta: {
        _type: "ctaLink",
        label: "View Docs",
        href: "https://velt.dev/docs/realtime-collaboration/crdt/setup/blocknote",
        newTab: true,
      },
      primaryCta: {
        _type: "ctaLink",
    ...
    getStartedCallout: {
      ...
      viewDocsHref:
        "https://velt.dev/docs/realtime-collaboration/crdt/setup/blocknote",
