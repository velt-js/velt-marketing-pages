...
const doc = {
  ...
  enterprise: {
    badges: [...DEPLOYMENT_BADGES, "Per-customer isolation", "GDPR deletion", "Legal hold", "Beta"],
    line: `Review intelligence is isolated per customer with physical namespace separation: a foreign sourceId returns empty results and never a cross-tenant read. GDPR deletion, legal hold, and per-content-type retention are part of the model. Beta access requires being added to the beta list. ${CLOUD_STATUS_LINE}`,
