...
const doc = {
  ...
  enterprise: {
    ...
    line: `User identity behind every avatar can stay on your infrastructure via the users data provider, with Velt storing only user IDs. Presence, cursors, and selection run on the same isolation guarantees as the rest of the SDK. ${CLOUD_STATUS_LINE}`,
