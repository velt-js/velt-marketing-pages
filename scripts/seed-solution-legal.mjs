    ...
    items: keyed(
      [
        ...
        },
        {
          ...
          body: `Run all of Velt inside your own cloud account, or keep just the comment and suggestion content plus user PII in your database while Velt holds IDs only. ${CLOUD_STATUS_LINE} Data residency options include the EU.`,
