...
const doc = {
  ...
  hero: {
    ...
    demoTabs: keyed(
      [
        ...
        { id: "page", label: "Page", demoPreset: "comments/hero/page" },
  ...
  enterprise: {
    ...
    line: `Comment content can live on your infrastructure via the self-host data provider, with only minimal identifiers on Velt. GDPR deletion runs through the compliance API with its own audit log. Comments run on the same isolation guarantees as the rest of the SDK. ${CLOUD_STATUS_LINE}`,
