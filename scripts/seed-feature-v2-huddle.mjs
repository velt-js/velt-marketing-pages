...
const doc = {
  ...
  enterprise: {
    badges: [...DEPLOYMENT_BADGES, "EU data residency", "Self-host identity"],
    line: `User identity behind every participant can stay on your infrastructure via the user's data provider, with Velt storing only user IDs. Huddle runs on the same SOC 2 controls and isolation guarantees as the rest of the SDK. ${CLOUD_STATUS_LINE}`,
